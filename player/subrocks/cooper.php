...
<body style="color:white; background-color:black;">
    ...
    <div class="video-stream" style="
        ...
        left: 0px;
    ">
    <video id="video-stream" src="https://cdn.discordapp.com/attachments/1076342894102851615/1114371544978833449/cooper2723anthem.mp4" onclick="playVid()" style="width:100%; height:100%; margin-top:-12px;">
    </video>
